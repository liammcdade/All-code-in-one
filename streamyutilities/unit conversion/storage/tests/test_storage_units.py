...
class TestStorageConversions(unittest.TestCase):
    ...
    def test_convert_storage_multi_step(self):
        ...
        self.assertAlmostEqual(
            convert_storage(1048576, "KB", "TB"), 1048576 / (1024 * 1024 * 1024)
        )  # 1 KB is 1/(1024^3) TB
    ...
    def test_invalid_units(self):
        ...
        self.assertIsNone(
            convert_storage(1, "BYTES", "KB")
        )  # BYTES is not valid, should be B
        self.assertIsNone(
            convert_storage(1, "kb", "megabytes")
        )  # megabytes is not valid
