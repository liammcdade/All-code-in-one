...
def convert_markdown_to_html(input_filepath, output_filepath=None):
    ...
    if output_filepath is None:
        ...
        if ext.lower() not in ['.md', '.markdown', '.mdown', '.mkd']:
            print(f"Warning: Input file '{input_filepath}' does not have a common Markdown extension.")
    ...
    try:
        ...
        print(f"An unexpected error occurred while writing HTML to '{output_filepath}': {e}")
        return False
