    ...
    if os.path.isfile(source_path):
        ...
        if archive_format == "zip":
            backup_filepath = os.path.join(
                backup_dest_dir, f"{backup_filename_base}.zip"
            )
            try:
                ...
                print(
                    f"Successfully backed up directory '{source_path}' to '{backup_filepath}'"
                )
            except Exception as e:
            ...
            backup_filepath = os.path.join(
                backup_dest_dir, f"{backup_filename_base}.tar.gz"
            )
            try:
            ...
            print(
                f"Error: Unsupported archive format '{archive_format}'. Use 'zip' or 'tar.gz'."
            )
    else:
